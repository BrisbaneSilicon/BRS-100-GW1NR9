...
prog_flashscript=program_flash.tcl
...
print_usage () {
    echo -e "Usage: ./program TARGET_DEVICE MCS_FILE_FULLPATH FLASH_DEVICE"
}
...
setup
vivado -mode batch -log $log_dir/build.log -journal $log_dir/journal.jou -source $prog_flashscript -tclargs $1 $2 $3
cleanup
