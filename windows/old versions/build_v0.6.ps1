...
# version 0.6 - read chip settings from CSV, only hardcoded paths to match build.tcl structure
...
$DeviceId      = $device.'Device'.Trim()        # e.g. GW1NR-9
...
## generate_top_wrapper.ps1 — match Linux pattern of checking script exists before sourcing
