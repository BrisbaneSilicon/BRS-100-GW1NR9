...
# define common paths for GOWIN v1.9.12 and v1.9.12.02
$commonPaths = @(
    ...
    "$env:LOCALAPPDATA\Gowin\Gowin_V1.9.12_x64",
    "$env:LOCALAPPDATA\Gowin\Gowin_V1.9.12"
)
...
if ($installFolderName -like "*1.9.12.01*") {
    Write-Host ""
    Write-Host "WARNING: GOWIN EDA V1.9.12.01 has a bug that stops BRS-100-GW1NR9 from programming."
    Write-Host "While it is okay for building, consider downloading V1.9.12 or V1.9.12.02 if you"
    Write-Host "wish to program the board from the same device."
    Write-Host "Please install V1.9.12 or V1.9.12.02 from:"
    Write-Host "https://www.gowinsemi.com/en/support/download_eda/"
}

elseif ($installFolderName -like "*1.9.12.02*") {
    ...
    Write-Host "         Recommended version: V1.9.12.02"
