...
After building the BRS-100-GW1NR9 firmware you are ready to program it to the board! After plugging the board into your PC via the USB-C cable, simply perform the following:
